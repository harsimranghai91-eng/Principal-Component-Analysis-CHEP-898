...
None of the categorical variables was found to be associated with dependent variable (all P>0.05). However, all the principal components were statistically significant and showed negative association with the dependent variable.
